...
class DifSpecMultDifIamodDifAddEnv(DifSpecMultDifSpec, StdAddEnv):
    ...
    def init(node_tree):
        ...
        remap_alpha_n.name = remap_alpha_n.label = DifSpecMultDifSpec.REMAP_ALPHA_GNODE
        remap_alpha_n.location = (start_pos_x + pos_x_shift * 2, start_pos_y + 1800)
        ...
        StdAddEnv.add(node_tree,
                      ...
                      node_tree.nodes[DifSpecMultDifSpec.REMAP_ALPHA_GNODE].outputs['Weighted Alpha'],
        ...
        # delete existing
        node_tree.nodes.remove(node_tree.nodes[DifSpecMultDifIamodDifAddEnv.MULT_BASE_A_MIX_NODE])
        ...
        iamod_tex_n.name = DifSpecMultDifIamodDifAddEnv.IAMOD_TEX_NODE
        iamod_tex_n.label = DifSpecMultDifIamodDifAddEnv.IAMOD_TEX_NODE
        ...
        iamod_multbase_col_mix_n.label = DifSpecMultDifIamodDifAddEnv.IAMOD_MULTBASE_COL_MIX_NODE
    ...
    def set_iamod_texture(node_tree, image):
        ...
        node_tree.nodes[DifSpecMultDifIamodDifAddEnv.IAMOD_TEX_NODE].image = image
    ...
    def set_iamod_texture_settings(node_tree, settings):
        ...
        :type settings: str
        """
        _material_utils.set_texture_settings_to_node(node_tree.nodes[DifSpecMultDifIamodDifAddEnv.IAMOD_TEX_NODE], settings)
    ...
    def set_iamod_uv(node_tree, uv_layer):
        ...
        node_tree.nodes[DifSpecMultDifIamodDifAddEnv.THIRD_UVMAP_NODE].uv_map = uv_layer
