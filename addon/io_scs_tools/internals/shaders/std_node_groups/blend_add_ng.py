...
def __create_node_group__():
    ...
    # inputs defining
    blend_add_g.interface.new_socket(in_out = "INPUT", socket_type = "NodeSocketShader", name = "Shader")

    # outputs defining
    blend_add_g.interface.new_socket(in_out = "OUTPUT", socket_type = "NodeSocketShader", name = "Shader")
